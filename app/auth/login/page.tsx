    ...
    <main>
      ...
      <CenteredPage>
        <div className="md:w-[500px] w-[300px]">
          <div>
            <h2 className="dark:text-gradient text-wellgab-black-1 text-center font-semibold text-[2rem]">
              Create your account
            </h2>
          ...
          <div className="mt-[32px]">
            <form>
              <div className="mb-4">
                <label
                  htmlFor="email"
                  className="pb-3 block text-wellgab-black-1 font-medium text-sm text-left"
                >
                  Email
                </label>
                <input
              ...
              <div className="flex flex-col items-center justify-center gap-4 my-4">
                <button className="border-[0.3px] border-wellgab-black-2 rounded-lg py-2 px-7 dark:text-white text-wellgab-black-1 text-lg text-left font-normal w-full hover:text-grey-800 hover:border-0 focus:text-grey-100 flex gap-4">
                  <Image priority src={Google} alt="Google sign in button" />
                  Continue with Google
                </button>
                <button className="border-[0.3px] border-wellgab-black-2 rounded-lg py-2 px-6 dark:text-white text-wellgab-black-1 text-lg text-left font-normal w-full hover:text-grey-800 hover:border-0 focus:text-grey-100 flex gap-4">
                  <Image
                    priority
                    src={Microsoft}
