...
const Page = () => {
  ...
  return (
    <section className="dark:bg-[#202124] min-h-screen pb-14 ">
      ...
      <div className="px-8 lg:px-[6.25rem] font-plusJakartaSans mt-16">
        <h1 className=" text-3xl lg:text-[40px] dark:text-transparent bg-clip-text bg-hero-gradient font-semibold text-center">
          Hello, I am WellGab. Your AI assistant for all your <br /> symptoms
          and diagnosis questions
        </h1>
        <div className="flex items-center mt-5 gap-x-2 mx-auto lg:w-max">
          <WarningIcon />
      ...
      <div className="bg-[#F5FAFA] dark:bg-[#24252B] mx-4 lg:mx-[6.25rem] p-4 md:p-8 mt-7 rounded-lg font-plusJakartaSans">
        <div className=" w-full h-full ">
          <div className="w-full h-[50vh] overflow-y-scroll space-y-6 py-4 text-sm lg:tex-base">
          ...
          <div className=" w-full space-y-10">
            ...
            <div className=" w-full bg-bg-utilize rounded-xl py-5">
              <p className=" lg:text-xl font-semibold text-center text-white">
